  ...
  page?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Page, 'id' | 'title' | 'body'> & {
      ...
      witnessV2Para?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      witnessV3?: StorefrontAPI.Maybe<{
        reference?: StorefrontAPI.Maybe<
          | Pick<StorefrontAPI.GenericFile, 'url'>
          | {sources: Array<Pick<StorefrontAPI.VideoSource, 'url'>>}
        >;
      }>;
      witnessV3Title?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      witnessV3Para?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      witnessV4?: StorefrontAPI.Maybe<{
        reference?: StorefrontAPI.Maybe<
          | Pick<StorefrontAPI.GenericFile, 'url'>
          | {sources: Array<Pick<StorefrontAPI.VideoSource, 'url'>>}
        >;
      }>;
      witnessV4Title?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      witnessV4Para?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      witnessV5?: StorefrontAPI.Maybe<{
        reference?: StorefrontAPI.Maybe<
          | Pick<StorefrontAPI.GenericFile, 'url'>
          | {sources: Array<Pick<StorefrontAPI.VideoSource, 'url'>>}
        >;
      }>;
      witnessV5Title?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
      witnessV5Para?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'value'>
      >;
...
export type StoryPageQueryVariables = StorefrontAPI.Exact<{
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  handle: StorefrontAPI.Scalars['String']['input'];
}>;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query StoryPage(\n    $language: LanguageCode,\n    $country: CountryCode,\n    $handle: String!\n  )\n  @inContext(language: $language, country: $country) {\n    page(handle: $handle) {\n      id\n      title\n      body\n    }\n  }\n': {
    return: StoryPageQuery;
    variables: StoryPageQueryVariables;
  };
}
