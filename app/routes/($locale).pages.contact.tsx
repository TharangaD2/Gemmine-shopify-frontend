...
// Asset imports
import white_ring from '~/assets/vedio/white_ring.mp4';
  ...
  return (
    <div className="min-h-screen bg-[#f8f5f0]">
      ...
      <div className="relative h-[75vh] bg-[#1a1a1a] overflow-hidden">
        ...
        >
          <source src={white_ring} type="video/mp4" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <p className="text-gray-600 mt-6 leading-relaxed text-lg font-light">
                Whether you're looking for the perfect piece for a special
                occasion or need assistance with an existing order, our team is
                here to help.
              </p>
